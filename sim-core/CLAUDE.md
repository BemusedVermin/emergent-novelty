...
| Creusot proofs | `creusot` | Creusot's pinned nightly (currently `nightly-2026-04-21`); see `creusot-verify` CI job | Linux/WSL only (Why3 + Z3 + Creusot from source) | Inductive / quantifier-heavy laws via Why3 + SMT or Coq |
